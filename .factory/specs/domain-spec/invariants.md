...
> DI-003 + DI-005 + DI-008 together are the product's credibility thesis: a number that cannot hide a fatal gap, cannot move without naming why, and can be re-derived by hand.
